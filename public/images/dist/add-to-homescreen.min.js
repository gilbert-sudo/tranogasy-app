  ...
  class e {
    ...
    _genErrorMessage(e, s, t) {
      var n =
        ...
        t +
        '</div><button class="adhs-error-copy-link-button" onclick="AddToHomeScreen.copyToClipboard();" ontouchstart="AddToHomeScreen.copyToClipboard();">Copy Website Link to Clipboard</button>' +
        this._genModalEnd();
      e.innerHTML = n;
    }
    ...
    _genTitle() {
      return this._genTitleWithMessage(
        "Install the " + this.appName + " app to continue"
      );
    }
    _genModalStart() {
    ...
    _genIOSSafari(e) {
      var s =
        ...
        this._genListItem(
          "1",
          'Tap the <img class="adhs-ios-safari-sharing-api-button" src="' +
            this._genAssetUrl("ios-safari-sharing-api-button.svg") +
            '"/> button below.'
        ) +
        this._genListItem(
          "2",
          'Select <img class="adhs-ios-safari-add-to-home-screen-button" src="' +
            this._genAssetUrl("ios-safari-add-to-home-screen-button.svg") +
            '"/> from the menu that pops up. <span class="adhs-emphasis">You may need to scroll down to find this menu item.</span>'
        ) +
        this._genListItem(
          "3",
          'Open the <img class="adhs-your-app-icon" src="' +
            this.appIconUrl +
            '"/> app.'
        ) +
        this._genListEnd() +
    ...
    _genIOSChrome(e) {
      var s =
        ...
        this._genListItem(
          "1",
          'Tap the <img class="adhs-ios-chrome-more-button" src="' +
            this._genAssetUrl("ios-chrome-more-button.svg") +
            '"/> button in the upper right corner.'
        ) +
        this._genListItem(
          "2",
          'Select <img class="adhs-ios-chrome-add-to-home-screen-button" src="' +
            this._genAssetUrl("ios-chrome-add-to-home-screen-button.svg") +
            '"/> from the menu that pops up. <span class="adhs-emphasis">You may need to scroll down to find this menu item.</span></b>'
        ) +
        this._genListItem(
          "3",
          'Open the <img class="adhs-your-app-icon" src="' +
    ...
    _genIOSInAppBrowserOpenInSystemBrowser(e) {
      var s =
        ...
        this._genListItem(
          "1",
          'Tap the <img class="adhs-more-button" src="' +
    ...
    _genAndroidChrome(e) {
      var s =
        ...
        this._genListItem(
          "1",
          'Tap the <img class="adhs-android-chrome-more-button" src="' +
            this._genAssetUrl("android-chrome-more-button.svg") +
            '"/> button in the browser bar.'
        ) +
        this._genListItem(
          "2",
          'Tap the <img class="adhs-android-chrome-add-to-homescreen-button" src="' +
            this._genAssetUrl("android-chrome-add-to-home-screen-button.svg") +
            '"/>or <img class="adhs-android-chrome-install-app" src="' +
    ...
    static copyToClipboard() {
      ...
      try {
        window.navigator.clipboard.writeText(e),
          ...
          )[0].innerHTML = "Link Copied to Clipboard!");
      } catch (e) {
        document.getElementsByClassName(
          "adhs-error-copy-link-button"
        )[0].innerHTML =
