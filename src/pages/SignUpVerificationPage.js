...
const SignUpVerificationPage = () => {
  ...
  const [error, setError] = useState(false); // Countdown timer in seconds
  ...
  const { finalizeSignup, isLoading } = useSignup();
  ...
  const handleResendCode = async () => {
    // Implement the code to resend the verification code here
