...
export const useSubscription = () => {
  ...
  const notSubscribedPopup = async () => {
    Swal.fire({
      ...
      html: `<img src="images/not-premium.png" alt="please log in" class="img-fluid"><br> Nous sommes désolés, mais vous devez disposer d'un forfait pour effectuer cette action. Veuillez acheter un forfait pour continuer !`,
