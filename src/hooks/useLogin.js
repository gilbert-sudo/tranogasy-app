...
export const useLogin = () => {
  ...
  const notLogedPopUp = async () => {
    Swal.fire({
      ...
      html: `<img src="images/not-loged.png" alt="please log in" class="img-fluid"><br> Pour aimer et sauvegarder des articles, connectez-vous ou créez votre compte gratuitement. Merci !`,
